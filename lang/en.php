...
return [
    ...
    'Catálogo de servicios'=>'Service catalog','Nuevo servicio'=>'New service','Editar servicio'=>'Edit service',
    'Servicio'=>'Service','Servicios'=>'Services','Código'=>'Code','Duración (min)'=>'Duration (min)','Duración'=>'Duration',
    'Se cotiza por pieza dental'=>'Priced per tooth','Por diente'=>'Per tooth',
    'Al agregarlo a un presupuesto se pedirá el diente y las caras tratadas.'=>'When added to a quote you will be asked for the tooth and treated surfaces.',
    'Aún no tienes servicios en el catálogo.'=>'You have no services in the catalog yet.',
    'Da de alta tus procedimientos con su precio para poder armar presupuestos.'=>'Add your procedures with their price so you can build quotes.',
    'Todas las categorías'=>'All categories','Activos'=>'Active','Inactivos'=>'Inactive','Todos'=>'All',
    'Sin resultados con este filtro.'=>'No results with this filter.',
    'El precio no puede ser negativo.'=>'The price cannot be negative.',
    'Limpieza dental, Consulta de valoración…'=>'Dental cleaning, Initial consultation…','Preventivo, Endodoncia…'=>'Preventive, Endodontics…',

    // Presupuestos / planes de tratamiento
    'Presupuesto'=>'Quote','Presupuestos'=>'Quotes','Nuevo presupuesto'=>'New quote','Editar presupuesto'=>'Edit quote',
    'Presupuestos de'=>'Quotes for','Ver todos'=>'View all','Todavía no hay presupuestos.'=>'No quotes yet.',
    'Borrador'=>'Draft','Propuesto'=>'Proposed','Aceptado'=>'Accepted','Terminado'=>'Completed',
    'Rechazado'=>'Rejected','Cancelado'=>'Cancelled','Marcar como'=>'Mark as',
    'Tratamiento aceptado'=>'Accepted treatment','Cobrado (abonos)'=>'Collected (payments)','Por cobrar'=>'Outstanding',
    'En espera de respuesta'=>'Awaiting response','Avance'=>'Progress','Abonado'=>'Paid','Saldo'=>'Balance',
    'procedimientos'=>'procedures','Procedimientos'=>'Procedures','Procedimiento'=>'Procedure','realizados'=>'completed',
    'Agregar procedimiento'=>'Add procedure','Agrega al menos un procedimiento.'=>'Add at least one procedure.',
    'Concepto libre'=>'Custom item','Diente'=>'Tooth','Caras'=>'Surfaces','Vigencia'=>'Valid until','Vigente hasta'=>'Valid until',
    'Notas para el paciente'=>'Notes for the patient','Guardar presupuesto'=>'Save quote','Presupuesto guardado.'=>'Quote saved.',
    'El descuento no puede ser mayor que el subtotal.'=>'The discount cannot exceed the subtotal.',
    'Un presupuesto aceptado ya no se puede editar.'=>'An accepted quote can no longer be edited.',
    'Tu catálogo de servicios está vacío. Puedes capturar conceptos libres, pero cargarlo te ahorra tiempo.'=>'Your service catalog is empty. You can enter custom items, but filling it in saves time.',
    'Agregar servicios'=>'Add services','Ese cambio de estado no es válido.'=>'That status change is not valid.',
    'Solo se marcan procedimientos en un presupuesto aceptado.'=>'Procedures can only be marked on an accepted quote.',
    'Todos los procedimientos están realizados: el tratamiento se marcó como terminado.'=>'All procedures are done: the treatment was marked as completed.',
    'Marcar como realizado'=>'Mark as completed','Marcar como pendiente'=>'Mark as pending','Realizado'=>'Completed',
    'Estado de cuenta'=>'Account statement','Registrar abono'=>'Record payment','Agregar abono'=>'Add payment',
    'Abonos'=>'Payments','Abonos recibidos'=>'Payments received','Abono registrado.'=>'Payment recorded.',
    'Abono eliminado.'=>'Payment deleted.','¿Eliminar este abono?'=>'Delete this payment?',
    'Monto'=>'Amount','Método'=>'Method','Referencia'=>'Reference','Liquidado'=>'Paid in full',
    'Solo se registran abonos en un presupuesto aceptado.'=>'Payments can only be recorded on an accepted quote.',
    'El monto del abono debe ser mayor que cero.'=>'The payment amount must be greater than zero.',
    'El abono no puede ser mayor que el saldo pendiente.'=>'The payment cannot exceed the outstanding balance.',
    'Los abonos se habilitan cuando el paciente acepta el presupuesto.'=>'Payments are enabled once the patient accepts the quote.',
    'Eliminar presupuesto'=>'Delete quote','Presupuesto eliminado.'=>'Quote deleted.',
    '¿Eliminar este presupuesto? No se puede deshacer.'=>'Delete this quote? This cannot be undone.',
    'Este presupuesto tiene abonos: cancélalo en lugar de eliminarlo.'=>'This quote has payments: cancel it instead of deleting it.',
    'Un tratamiento terminado no se elimina.'=>'A completed treatment cannot be deleted.',
    'Imprimir / Guardar como PDF'=>'Print / Save as PDF','Atiende'=>'Provider',
    'Firma del paciente'=>'Patient signature','Firma del profesional'=>'Provider signature',
    'Este presupuesto es informativo y no constituye un comprobante fiscal.'=>'This quote is informational and is not a tax receipt.',
    'Los precios se respetan hasta la fecha de vigencia indicada.'=>'Prices are honored until the validity date shown.',
    'Oclusal'=>'Occlusal','Mesial'=>'Mesial','Distal'=>'Distal','Vestibular'=>'Buccal','Lingual/Palatina'=>'Lingual/Palatal',
    'Estado del servicio actualizado.'=>'Service status updated.',

    // Odontograma por caras
    'Hallazgo'=>'Finding','Hallazgos'=>'Findings','A tratar'=>'To treat','Por tratar'=>'To treat','Realizados'=>'Completed',
    'Borrar'=>'Erase','Nota'=>'Note','Resumen'=>'Summary','Leyenda'=>'Legend','Limpiar todo'=>'Clear all',
    'Caries'=>'Cavity','Obturado'=>'Filled','Obturación'=>'Filling','Sellante'=>'Sealant','Fractura'=>'Fracture',
    'Corona'=>'Crown','Endodoncia'=>'Root canal','Implante'=>'Implant','Prótesis'=>'Prosthesis',
    'Ausente'=>'Missing','Extracción'=>'Extraction',
    'Afecta al diente completo'=>'Affects the whole tooth',
    'Elige capa y estado, luego haz clic en una cara del diente. El icono ▣ marca los estados que afectan al diente completo.'=>'Pick a layer and a state, then click a tooth surface. The ▣ icon marks states that affect the whole tooth.',
    'Relleno sólido: hallazgo actual.'=>'Solid fill: current finding.',
    'Rayado: tratamiento por hacer.'=>'Hatched: treatment to be done.',
    'Punto central: tratamiento realizado.'=>'Center dot: treatment completed.',
    'Borde del recuadro: estado del diente completo.'=>'Box border: whole-tooth state.',
    'Odontograma guardado.'=>'Dental chart saved.','Edición manual'=>'Manual edit',
    '¿Quitar todas las marcas del odontograma?'=>'Remove all marks from the dental chart?',
    'Historial'=>'History','Historial del odontograma'=>'Dental chart history','Editar odontograma'=>'Edit dental chart',
    'Versiones'=>'Versions','Actual'=>'Current','Solo lectura'=>'Read only',
    'Todavía no hay versiones guardadas.'=>'No saved versions yet.',
    'Generar presupuesto'=>'Create quote','diente'=>'tooth','Derecha'=>'Right','Izquierda'=>'Left',
    'Superior'=>'Upper','Inferior'=>'Lower',
    'Procedimiento realizado'=>'Procedure completed','Generado desde el odontograma.'=>'Generated from the dental chart.',
    'No hay tratamientos marcados como requeridos en el odontograma.'=>'No treatments are marked as required in the dental chart.',
    'Presupuesto creado desde el odontograma. Revisa precios y conceptos antes de proponerlo.'=>'Quote created from the dental chart. Review prices and items before proposing it.',

    // Pago en línea (Mercado Pago del consultorio)
    'Pago en línea — Mercado Pago'=>'Online payments — Mercado Pago',
    'Modo pruebas'=>'Test mode','Producción'=>'Production','privado'=>'private','frontend, requerida'=>'frontend, required',
    'Conecta tu cuenta de Mercado Pago para cobrar en línea a tus pacientes. El dinero cae en TU cuenta.'=>'Connect your Mercado Pago account to charge your patients online. The money goes to YOUR account.',
    'Obtén tus credenciales en'=>'Get your credentials at','tu panel de desarrollador'=>'your developer panel',
    'Usa credenciales de prueba (TEST-) para probar y de producción (APP_USR-) para cobrar de verdad.'=>'Use test credentials (TEST-) to try it out and production ones (APP_USR-) to charge for real.',
    'Habilitar pago en línea para mis pacientes'=>'Enable online payments for my patients',
    'No lo compartas. Se usa para crear los cobros desde el servidor.'=>'Do not share it. It is used to create charges from the server.',
