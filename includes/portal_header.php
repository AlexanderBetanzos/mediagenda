    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="pnav">
            <ul class="navbar-nav me-auto">
                <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/portal/index"><i class="bi bi-calendar-check"></i> Mis citas</a></li>
                <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/portal/recetas"><i class="bi bi-capsule"></i> Recetas</a></li>
                <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/portal/archivos"><i class="bi bi-paperclip"></i> Estudios</a></li>
            </ul>
            <div class="d-flex align-items-center gap-3">
                <span class="text-muted small"><i class="bi bi-person-circle"></i> <?= e(($pac['nombre'] ?? '') . ' ' . ($pac['apellidos'] ?? '')) ?></span>
                <a href="<?= BASE_URL ?>/portal/logout" class="btn btn-sm btn-outline-secondary"><i class="bi bi-box-arrow-right"></i> Salir</a>
            </div>
        </div>
    </div>
</nav>
