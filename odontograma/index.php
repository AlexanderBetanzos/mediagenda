...
.paleta-btn.active{opacity:1;outline:3px solid var(--brand,#2563eb);outline-offset:2px;box-shadow:0 2px 8px rgba(0,0,0,.18)}
#btnBorrar.active,#btnNota.active{color:#fff;background:var(--brand,#2563eb);border-color:var(--brand,#2563eb)}
</style>
