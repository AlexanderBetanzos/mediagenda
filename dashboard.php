...
<div class="card mb-4">
    <div class="card-body">
        ...
        <div class="row g-3 text-center">
            ...
            <div class="col-md-4"><div class="p-2"><div class="fw-bold" style="font-size:1.5rem;color:#3f9aa3"><?= fmt_money($pendienteCobrar) ?></div><div class="text-muted small"><?= et('Pendiente por cobrar') ?></div></div></div>
...
<div class="row g-3 mb-4">
    ...
    if ($verCitas) {
        ...
        $row2[] = [et('Por confirmar'), number_format($citasPorConfirmar), 'bi-hourglass-split', '#3f9aa3', BASE_URL.'/citas/index', false];
...
html.app-dark .welcome-banner {
    background: linear-gradient(135deg, rgba(31,107,115,.16), rgba(255,214,10,.05));
...
(function () {
    ...
    var brand   = (css.getPropertyValue('--brand').trim() || '#1f6b73');
    ...
    var PALETTE = [brand, '#4fa8b0', '#ffd60a', '#38bdf8', '#22c55e', '#a78bfa', '#ef4444', '#3f9aa3', '#14b8a6', '#ec4899'];
