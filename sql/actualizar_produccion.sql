-- =====================================================================
--  MediOS — Actualización de BD (todas las migraciones de features)
...
-- ============ sql/planes.sql ============
-- =====================================================================
--  MediOS  -  Planes y entitlements (módulos por plan)
...
-- ============ sql/seguridad.sql ============
-- =====================================================================
--  MediOS  -  Seguridad: auditoría + 2FA (TOTP)
--  Ejecutar DESPUÉS de multitenant.sql. Idempotente en MariaDB.
-- =====================================================================
...
-- ============ sql/expediente.sql ============
-- =====================================================================
--  MediOS  -  Expediente inteligente (campos clínicos e identificación)
--  Ejecutar DESPUÉS de schema.sql/multitenant.sql. Idempotente en MariaDB.
...
-- ============ sql/agenda.sql ============
-- =====================================================================
--  MediOS  -  Agenda pro: horarios por médico y bloqueos
--  Ejecutar DESPUÉS de schema.sql/multitenant.sql. Idempotente en MariaDB.
-- =====================================================================
...
-- ============ sql/crm.sql ============
-- =====================================================================
--  MediOS  -  CRM (seguimiento de pacientes)
...
-- ============ 2026-07-24: medicamentos actuales del paciente ============
...
-- ============ 2026-07-24: nutrición (valoraciones antropométricas) ============
...
-- ============ 2026-07-24: dermatología (lesiones + fotos comparativas) ============
