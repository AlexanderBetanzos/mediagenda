...
<head>
    ...
    <style>
        ...
        .plat-badge { font-size:.6rem; letter-spacing:1.5px; font-weight:800; padding:.15rem .5rem; border-radius:6px; background:rgba(46,144,224,.18); color:#7cc2f5; }
    </style>
</head>
<body>
<div class="card plat-card">
    <div class="card-body p-4 p-sm-5">
        <div class="text-center mb-4">
            <div class="display-6" style="color:#0b6fb8"><i class="bi bi-diagram-3-fill"></i></div>
